...
1. 运行主引擎：`${CLAUDE_PLUGIN_ROOT}/skills/world-cup-predictor/scripts/full_prediction.py`
2. 读取当天报告：`${CLAUDE_PLUGIN_ROOT}/skills/world-cup-predictor/reports/YYYYMMDD.md`
3. 按问题类型只输出对应内容
